...
! function (n) {
	...
	n.fn.openAccessibility = function (e) {
		function d() {
			b.isMenuOpened ? (x.fadeOut(50), f.fadeIn(50), w.removeClass("open-accessibility-collapsed"), w.addClass("open-accessibility-expanded")) : (x.fadeIn(50), f.fadeOut(50), w.removeClass("open-accessibility-expanded"), w.addClass("open-accessibility-collapsed"));
			var n = [];
